...
export class CreateQuotationDto{
    ...
    static create(object : {[key: string] : any}) : [string?, CreateQuotationDto?]{
        const{prospect_id, service_id, user_id, net_amount, discount, quotation_date, final_delivery_date, description, important, billing, igv_included, type_currency, bank, bank_code, interbank_code, detraction_account, stages} = object;
        ...
        return [undefined, new CreateQuotationDto(prospect_id, service_id, user_id, net_amount, discount, quotation_date, final_delivery_date, description, important, billing, igv_included, type_currency, bank, bank_code, interbank_code, detraction_account, stages)]
    }
}